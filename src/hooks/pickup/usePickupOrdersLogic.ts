...
export const usePickupOrdersLogic = () => {
  ...
  const { 
    ...
    handlePrintTicket, handleNotifyClient, handleOrderReady 
  ...
  return {
    ...
    handleOrderReady: (ticketId: string, phoneNumber?: string) => 
      handleOrderReady(ticketId, phoneNumber, pickupTickets),
